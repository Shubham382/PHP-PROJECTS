  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Abhi.png" width=100 height=100 alt="Abhishek Sajgane" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Abhishek Sajgane</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919011423608</h4>
		<h4 style="font-family:'typo' ">abhisheksajgane1311@gmail.com</h4>
		<h4 style="font-family:'typo' ">Deogiri College, Aurangabad</h4></div></div>
		</p>
      </div>
